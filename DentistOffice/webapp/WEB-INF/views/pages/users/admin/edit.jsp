...
<h4>Administrator - edycja swoich danych</h4>
	<form:form method="POST"
		action="${pageContext.request.contextPath}/users/admin/edit"
		modelAttribute="admin" enctype="multipart/form-data">
		<table>
			<tbody>
				<tr>
					<td rowspan="13"><img src="data:image;base64,${admin.base64Photo }" width="300px" /></td>
					<td>Login:</td>
