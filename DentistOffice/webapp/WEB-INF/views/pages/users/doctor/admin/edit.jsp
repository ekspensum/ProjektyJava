...
<h3>Panel administratora - edycja danych lekarza</h3>
	<form:form method="POST"
		...
		<table>
			<tbody>
				<tr>
					<td rowspan="13"><img src="data:image;base64,${doctor.base64Photo }" width="300px" /></td>
					<td>Login:</td>
				...
				<tr>
					...
					<td><form:select path="user.roles[1].id" multiple="false">
						<c:forEach items="${doctor.user.roles }" var="userRole">
...
<table>
	<tr>
		<td align="right" width="820px"><input type="submit" value="Zapisz zmiany" class="navigateButton" onclick="return checkCorrectPassword()" /></td>
	</tr>
</table>
<br>
</form:form>
