...
<h3><s:message code="register.header.patient" /></h3>
	<form:form method="POST"
		...
		<table>
			<tbody>
				...
				<tr>
					<td></td><td><input type="submit" value="<s:message code="button.register" />" class="navigateButton" onclick="return checkCorrectPassword()" /></td>
				</tr>
			</tbody>
		</table>
</form:form>
