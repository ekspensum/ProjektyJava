...
<h3><s:message code="edit.header.patient.assistant" /></h3>
	<form:form method="POST"
		action="${pageContext.request.contextPath}/users/patient/assistant/edit"
		modelAttribute="patient" enctype="multipart/form-data">
		<table>
			<tbody>
				<tr>
					<td rowspan="17"><img src="data:image;base64,${patient.base64Photo }" width="300px" /></td>
				...
				<tr>
					<td><s:message code="register.user.active" /></td>
				...
				<tr>
					<td></td><td><input type="submit" value="<s:message code="button.save" />" class="navigateButton" onclick="return checkCorrectPassword()" /></td>
				</tr>
			</tbody>
		</table>
	</form:form>
