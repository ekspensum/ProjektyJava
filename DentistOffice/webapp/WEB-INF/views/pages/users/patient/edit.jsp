...
<h3><s:message code="edit.header.patient.self" /></h3>
	...
	<form:form method="POST"
		...
		<table>
			<tbody>
				...
				<tr>
					<td></td><td><input type="submit" value="<s:message code="button.save" />" onclick="return checkCorrectPassword()" class="navigateButton" /></td>
				</tr>
			</tbody>
		</table>
	</form:form>
