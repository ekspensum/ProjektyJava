...
<form name="selectVisitForm" method="POST" action="${pageContext.request.contextPath}/visit/doctor/visitToFinalize">
<table>
	<tr>
		<td><input type="date" name="dateFrom" value="${dateFrom }" /></td>
		<td><input type="date" name="dateTo" value="${dateTo }" readonly="readonly" /></td>
		<td><button type="submit" formmethod="POST" formaction="${pageContext.request.contextPath}/visit/doctor/searchVisitToFinalize" class="navigateButton" onclick="return validateInputFieldsDateSearchVisits()" >Wyszukaj ponownie</button></td>
	</tr>
</table>
<br>
