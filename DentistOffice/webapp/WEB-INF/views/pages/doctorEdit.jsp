...
<h2>Doctor edit page</h2>
	<form:form method="POST"
		action="${pageContext.request.contextPath}/doctorEdit"
...
<c:forEach items="${workingWeekMap}" var="map" varStatus="vs1">
	<b>${map.key.value == 1 ? 'Poniedziałek' : map.key.value == 2 ? 'Wtorek' : map.key.value == 3 ? 'Środa' : map.key.value == 4 ? 'Czwartek' : map.key.value == 5 ? 'Piątek' : ''}</b></td></tr>
	<p>
