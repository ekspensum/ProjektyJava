...
<h4>${selectedTreatmentCategory.categoryName }:</h4>
	<table class="search">
		...
		<c:forEach items="${selectedTreatmentCategory.dentalTreatment }" var="treatment" varStatus="loop">
			<tr>
				<td>${loop.count }.</td><td>${treatment.name }</td><td>${treatment.price }</td><td style="width: 70%;"><textarea readonly="readonly" class="homePageTreatmentDescription">${treatment.description }</textarea></td></tr>
