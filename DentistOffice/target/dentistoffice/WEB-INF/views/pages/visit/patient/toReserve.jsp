...
<button type="submit" name="weekResultDriver" formmethod="POST" formaction="${pageContext.request.contextPath}/visit/patient/toReserve" value="stepLeft" ${disableLeftArrow eq 'YES' ? 'disabled' : '' } class="navigateButton" >Poprzednie 7 dni</button>
<button type="submit" name="weekResultDriver" formmethod="POST" formaction="${pageContext.request.contextPath}/visit/patient/toReserve" value="stepRight" ${disableRightArrow eq 'YES' ? 'disabled' : '' } class="navigateButton" >Następne 7 dni</button>
<br><br>
